...
class PuzzleRoot(FloatLayout):
    ...
    self.goat = Image(source="goat.png")
    self.farmer = Image(source="farmer.png")
    self.wolf = Image(source="wolf.jpg")
    self.cabbage = Image(source="cabbage.png")
    ...
    def goLeft(image, originalpos):
        pass

    def goRight(image, originalpos):
        pass
